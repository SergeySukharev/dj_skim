...
post_fun = 'test_inv.test_growplan'
finish_table = 'test_inv.res_calc_growplan_t'
static_start = 'bez_sutok/start/'
static_finish = 'bez_sutok/finish/'
...
def summoner():
    ...
    for i in range(len(finish_list)):
        ...
        with codecs.open(start_list[i], "r",'cp1251') as f:
