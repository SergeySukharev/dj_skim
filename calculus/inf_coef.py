...
post_fun = 'test_inv.test_influence_coef'
finish_table = 'test_inv.res_calc_influence_coef_t'
static_start = 'influence_coef/start/'
static_finish = 'influence_coef/finish/'
